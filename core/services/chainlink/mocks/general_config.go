...
import (
	...
	terra "github.com/smartcontractkit/chainlink/core/chains/terra"
...
// TerraConfigs provides a mock function with given fields:
func (_m *GeneralConfig) TerraConfigs() terra.TerraConfigs {
	ret := _m.Called()

	var r0 terra.TerraConfigs
	if rf, ok := ret.Get(0).(func() terra.TerraConfigs); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(terra.TerraConfigs)
		}
	}
